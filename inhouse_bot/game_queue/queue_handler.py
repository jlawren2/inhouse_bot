...
def add_player(
    player_id: int, channel_id: int, server_id: int = None, name: str = None, jump_ahead=False
):
    # Just in case
...
def add_duo(
    ...
    with session_scope() as session:
        ...
        first_queue_player = QueuePlayer(
            player_id=first_player_id, channel_id=channel_id, duo_id=second_player_id
        )

        second_queue_player = QueuePlayer(
            player_id=second_player_id, channel_id=channel_id, duo_id=first_player_id
        )
