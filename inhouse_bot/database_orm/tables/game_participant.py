...
from inhouse_bot.common_utils.fields import side_enum, foreignkey_cascade_options
...
class GameParticipant(bot_declarative_base):
    ...
    __table_args__ = (
        ...
        ForeignKeyConstraint(
            ...
            (PlayerRating.player_id, PlayerRating.player_server_id),
        ),
        {},
    )
    ...
    def __init__(self, side: player):
        ...
        self.trueskill_mu = player.ratings.trueskill_mu
        self.trueskill_sigma = player.ratings.trueskill_sigma
